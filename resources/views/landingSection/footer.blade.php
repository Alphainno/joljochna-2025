  <footer>
        <div class="footer-container">
                ...
                <div class="contact-info">
                    <div class="contact-item" style="background-color: #ffd700">
                        ...
                        <div class="phone-no" style="color: #0a4d2e">
                            <strong id="ftPhoneLabel" style="color: #0a4d2e">ফোন নম্বর</strong><br>
                    ...
                    <div class="contact-item" style="background-color: #ffd700">
                        ...
                        <div class="email" style="color: #0a4d2e">
                            <strong id="ftEmailLabel" style="color: #0a4d2e">ইমেইল</strong><br>
            ...
            <div class="footer-section" style="margin-left: 110px">
                ...
                <h3 id="ftContactAddressLabel">যোগাযোগের ঠিকানা</h3>
            ...
            <div class="footer-section" style="margin-left:110px">
                ...
                <h3 id="ftLegalInfoLabel">আইনি তথ্য</h3>
                <ul class="footer-links">
