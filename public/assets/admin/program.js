...
function showTab(tabId) {
    ...
    // Note: bookings tab has its own data loading in bookings.blade.php
...
// 3. Bookings Tab Logic - DISABLED (bookings.blade.php has its own implementation)
function renderBookingsTable_OLD_DISABLED(data) {
...
function filterBookings_OLD_DISABLED() {
    // DISABLED - bookings tab now has its own implementation
    return;
}
...
function deleteBooking(id) {
    ...
    if (index !== -1) {
        ...
        // renderBookingsTable(bookingsData); // DISABLED - using new API implementation
        renderOverview();
